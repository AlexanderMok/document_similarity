...
public class SimHashTest {
	...
	public void testSimhash() throws LoadModelException{
		...
		BigInteger simhashCode0 = SimHash.simHashCode(doc0, 64);
		BigInteger simhashCode1 = SimHash.simHashCode(doc1, 64);
		BigInteger simhashCode2 = SimHash.simHashCode(doc2, 64);
		BigInteger simhashCode3 = SimHash.simHashCode(doc3, 64);
		int distance = SimHash.hammingDistance(simhashCode1, simhashCode2);
		int distance2 = SimHash.hammingDistance(simhashCode1, simhashCode3);
		int distance3 = SimHash.hammingDistance(simhashCode0, simhashCode1);
